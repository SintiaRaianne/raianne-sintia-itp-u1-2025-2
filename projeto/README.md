...
- **Listagem de Livros**: Exibe todos os livros cadastrados, mostrando o ID, título, autor e o status atual (Disponível ou Emprestado).
...
- **Menu Interativo**: Apresenta o menu que permite ao usuário navegar entre as funcionalidades do sistema e encerr
- **Limpeza de Tela**: O terminal é limpo a cada nova interação no menu, proporcionando uma interface mais organizada e legível para o usuário.
